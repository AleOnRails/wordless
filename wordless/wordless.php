...
class Wordless {
  ...
  */
    ...
    public static function theme_procfile_path() {
        return self::join_paths(self::theme_path(), 'Procfile');
    }

    public static function theme_dotenv_path() {
        return self::join_paths(self::theme_path(), '.env');
    }

    public static function theme_webpackconfig_path() {
        return self::join_paths(self::theme_path(), 'webpack.config.js');
    }

    public static function theme_packagejson_path() {
        return self::join_paths(self::theme_path(), 'package.json');
    }

    public static function theme_webpackentrypoint_path() {
        return self::join_paths(self::theme_assets_path(), 'main.js');
    }
